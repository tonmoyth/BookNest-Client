...
const Service = () => {
  return (
    <section className="bg-secondary text-white py-16 px-4 md:px-20">
      <div className="grid md:grid-cols-2 gap-10 items-start">
        {/* Left Side */}
        <div>
          <p className="text-primary tracking-widest mb-2">➜ SERVICE</p>
          <h2 className="text-4xl text-accent md:text-5xl font-bold leading-tight mb-6">
            Enhancing Your’s <br />
          ...
          <div className="flex items-center gap-4 mt-6">
            ...
            <div>
              <p className="text-accent text-sm">For More Information</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {/* Transportations */}
          <div className="bg-accent p-6 rounded-md shadow transition duration-300 transform hover:scale-105 group hover:shadow-xl ">
