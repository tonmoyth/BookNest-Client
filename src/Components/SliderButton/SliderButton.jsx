...
const SliderButton = ({ level }) => {
  return (
    <div>
      <button
        href="#_"
        className="relative inline-flex items-center px-12 py-2 overflow-hidden text-lg font-medium text-secondary border-2 border-secondary rounded-full hover:text-white group hover:bg-gray-50"
      >
